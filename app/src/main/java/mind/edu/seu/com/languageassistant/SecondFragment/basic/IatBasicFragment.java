package mind.edu.seu.com.languageassistant.SecondFragment.basic;
...
import mind.edu.seu.com.languageassistant.SecondFragment.util.JsonParser;
 ...
 */
public class IatBasicFragment extends Fragment {
    private  int num=0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SpeechUtility.createUtility(this.getContext()
                , SpeechConstant.APPID + "="+getString(R.string.APPID));
        Log.d(TAG, "onCreate--->");
        initIat();
    ...
    private void initIat() {
        ...
        mIat = SpeechRecognizer.createRecognizer(this.getContext(), mInitListener);
        // 初始化听写Dialog，如果只使用有UI听写功能，无需创建SpeechRecognizer
        // 使用UI听写功能，请根据sdk文件目录下的notice.txt,放置布局文件和图片资源
        mIatDialog = new RecognizerDialog(this.getContext(), mInitListener);
        mSharedPreferences = getActivity().getSharedPreferences(PRIVATE_SETTING,
    ...
    public void setParam() {
        ...
        mIat.setParameter(SpeechConstant.ASR_AUDIO_PATH, Environment.getExternalStorageDirectory() + "/language/wavaudio.wav");
    }
        ...
        switch (v.getId()){
            case R.id.fragTwo_startBtn:
            {
                ...
                if (isShowDialog) {
                    // 显示听写对话框
                    num++;
                    mIat.setParameter(SpeechConstant.ASR_AUDIO_PATH, Environment.getExternalStorageDirectory() + "/iflytek/wavaudio"+num+".wav");
                ...
                break;
            case R.id.fragTwo_pauseBtn:
                mIat.stopListening();
                showTip("停止听写");
                break;
            case R.id.fragTwo_endBtn:
                mIat.cancel();
                showTip("取消听写");
                break;
        }
